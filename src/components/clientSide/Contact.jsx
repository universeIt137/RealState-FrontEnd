...
const Contact = () => {
  ...
  return (
    ...
    <div className="w-11/12 mx-auto">
        <div className='' >
          <h1 className = "text-center md:text-4xl mt-20 md:mt-28 md:mb-8  text-[#21c45e] mb-2 font-bold " >Visit Our Office</h1>
          <div className="flex flex-col md:flex-row items-center justify-center  gap-5 md:gap-8 p-6 md:p-12">
        
        <div className="flex flex-col border border-green-500 items-start bg-white shadow-lg p-6 rounded-lg w-full md:w-1/2 mb-6 md:mb-0">
          <div className="flex items-center justify-center bg-green-500 h-12 md:h-20 w-full rounded-t-lg">
            <h2 className="text-[14px] md:text-2xl font-semibold text-white">Amar Thikana Properties Ltd.</h2>
          </div>
