  ...
  const navLinks = [
    ...
    },
    {
      ...
      dropdownLinks: [
        ...
        { title: 'Project Images', path: '/project-details' },
        { title: 'Project Videos', path: '/project-details' },
        { title: 'Citizen Facilities', path: '/project-details' },
        { title: 'Our Features', path: '/project-details' },
        { title: 'Current Project Status', path: '/project-details' },
        { title: 'Project Layout', path: '/project-details' },
        { title: 'Privacy Policy', path: '/project-details' },
