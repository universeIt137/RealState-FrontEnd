...
function RealEstateAd() {
  return (
    <div className="bg-green-50 p-8 font-sans">
      {/* Offer and Promotion Heading */}
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-black">Offer and Promotion</h1>
        <p className="text-lg text-gray-700 mt-2">Exciting discounts and limited-time offers available!</p>
      </div>

      {/* Header Banner */}
      <div className="bg-[#1a9d4b] text-white p-4 rounded-lg flex items-center justify-center mb-6 card-hover">
        <div className="text-center">
          <h1 className="text-3xl font-bold mb-1">৫০% মূল্য পরিশোধ করলে সাব কবলা রেজিস্ট্রেশন</h1>
          <span className="text-sm bg-yellow-400 text-red-700 px-3 py-1 rounded inline-block">শর্ত প্রযোজ্য</span>
        </div>
      </div>

      {/* Main Question */}
      <div className="text-center mb-6">
        <h1 className="text-4xl font-bold text-green-700 mb-4">আপনি কি নিরাপদ আবাসন গড়ে তোলার জন্য জমি খুঁজছেন?</h1>
      ...
      <div className="">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg mb-6 card-hover">
          <h2 className="text-2xl font-bold text-[#21c45e] mb-4">প্রকল্পের অবস্থান</h2>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg mb-6 card-hover">
          <h2 className="text-2xl font-bold text-[#21c45e] mb-4">লক্ষ্য</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Features Section */}
        <div className="bg-white p-6 rounded-lg shadow-lg mb-6 card-hover">
          <h2 className="text-2xl font-bold text-[#21c45e] mb-4">বিশেষ সুবিধা সমূহ</h2>
      ...
      <div className="bg-green-500 text-white p-6 rounded-lg text-center card-hover">
        <p className="text-xl font-semibold mb-2">যোগাযোগ করুন</p>
        <p className="text-2xl font-bold mb-2">+88 01747-516981</p>
        <p className="text-lg mb-2">amarthikana06@gmail.com</p>
        <p className="text-lg">ঠিকানা: ৪৮, বিজয়নগর (৪র্থ তলা), ঢাকা-১০০০১</p>
      </div>
    </div>
  );
}
