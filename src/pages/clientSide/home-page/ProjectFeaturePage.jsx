    ...
    <div className='w-11/12   mx-auto ' >
      <div className=" rounded-lg shadow-lg">
        ...
        <div className="text-center">
          <button className="md:px-6 px-3 py-2 text-[10px] md:text-[16px] md:py-3 bg-[#027F3D] opacity-70 bg-transparent text-white my-3 font-bold rounded-lg hover:bg-green-600 transition-colors duration-300">
