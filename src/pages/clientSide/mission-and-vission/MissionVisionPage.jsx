...
const MissionVision = () => {
  ...
  return (
    ...
    <div className="w-full my-20 md:my-28 bg-gray-50">
        {/* Header */}
        <header className="text-center py-4 md:py-10 bg-[#21c45e] text-white rounded-lg shadow-lg">
        ...
        {/* Mission Section */}
        <section className="bg-[#21c45e] p-4 md:p-8 rounded-lg shadow-md my-4 md:my-8">
          <h2 className="md:text-4xl font-bold text-white text-center mb-2 md:mb-6">Our Mission</h2>
          <p className="text-white text-[10px]  md:text-lg text-center">
        ...
        {/* Vision Section */}
        <section className="bg-[#21c45e] p-4 md:p-8 rounded-lg shadow-md my-2 md:my-8">
          <h2 className="md:text-4xl font-bold text-white  text-center md:mb-6">Our Vision</h2>
          <p className="text-white text-[9px] md:text-lg text-center">
        ...
        {/* Core Values Section */}
        <section className="bg-gray-100 p-2 md:p-8 rounded-lg shadow-md my-3 md:my-8">
          <h2 className="md:text-4xl font-bold text-green-600 text-center mb-3 md:mb-6">Our Core Values</h2>
          <div className="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0">
            <div className="bg-[#21c45e] p-3 md:p-6 rounded-lg shadow-lg flex-1 text-center">
              <h3 className="md:text-4xl font-bold text-white  md:mb-4">Integrity</h3>
              <p className="text-white md:text-[16px] text-[9px] ">
                We uphold the highest standards of honesty and transparency in all our dealings.
              </p>
            </div>
            <div className="bg-[#21c45e] p-2 md:p-6 rounded-lg shadow-lg flex-1 text-center">
